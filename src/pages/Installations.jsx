...
const Installations = () => {
    ...
    const sortedApps =( ()=>{
        ...
        const sortedList = [...installedApps].sort((a,b) =>b.downloads -a.downloads )
        ...
        const sortedList = [...installedApps].sort((a,b) =>a.downloads -b.downloads )
    ...
    <div className=' flex justify-between items-center py-5'>
        <div>
            <h1 className='text-xl font-semibold '>{sortedApps.length} Apps found</h1>
        </div>
        <div>
          ...
          >
            <option disabled value='none'>Sort by Download</option>
    ...
    <div className='flex flex-col  gap-2 pb-6 min-h-[30vh]'>
         {
             sortedApps.map(app =><InstalledCard key={app.id} 
             app={app} 
