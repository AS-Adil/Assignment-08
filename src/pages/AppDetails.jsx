...
const AppDetails = () => {
    ...
    if(loading) return <p className='font-bold text-5xl text-center text-red-600'>loading.......</p>
    if(!app) return <p className='font-bold text-5xl text-center text-red-600'>Not Found.......</p>
    ...
    return (
        <div className=' bg-[#E9E9E9]'>
            ...
            <div className='pt-4'>
                    ...
                    <button className='bg-[#00D390] px-14 py-2.5 rounded-md font-semibold text-white text-lg shadow-md hover:shadow-lg cursor-pointer '
                    >Isntall Now ({app.size}GB)</button>
