...
const InstalledCard = ({app}) => {
    const {image, title, size, reviews, ratingAvg, downloads } = app
    return (
  ...
  <div className='pl-2 '>
    ...
    <div className='flex gap-3 items-center '>
         ...
         <button className="bg-[#00D390] px-8 py-2 rounded-md font-semibold text-white text-lg shadow-md hover:shadow-lg cursor-pointer ">
                Uninstall
              </button>
